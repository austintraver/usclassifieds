...
public class CreateProfileConfirm {
    ...
    public void createProfile() {
        ...
        ViewInteraction editFistName = onView(
                allOf(withId(R.id.edit_first_name),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction editLastName = onView(
                allOf(withId(R.id.edit_last_name),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editPhoneNumber = onView(
                allOf(withId(R.id.edit_phone_number),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editStreetNumber = onView(
                allOf(withId(R.id.edit_street_number),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editStreetName = onView(
                allOf(withId(R.id.edit_street_name),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editCityName = onView(
                allOf(withId(R.id.edit_city_name),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editStateName = onView(
                allOf(withId(R.id.edit_state_code),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction editZipCode = onView(
                allOf(withId(R.id.edit_zip_code),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction clickConfirm = onView(
                allOf(withId(R.id.update), withText("✔"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
